...
vim.o.shiftwidth = 2 --default 8
vim.o.tabstop = 2 --default 8
vim.o.softtabstop = 2 --default 8 (number of staces a tab represents)
...
vim.o.autowriteall = true --autosaves files
